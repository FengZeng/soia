...
export const messages: Record<string, string> = {
    ...
    "Alphabetical (A–Z, ascending)": "按字母排序（A–Z，升序）",
    "Alphabetical (Z–A, descending)": "按字母排序（Z–A，降序）",
    "Date added (newest, descending)": "添加日期（最新，降序）",
    "Date added (oldest, ascending)": "添加日期（最早，升序）",
